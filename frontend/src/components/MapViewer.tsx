...
const LegendControl = () => {
  ...
  useEffect(() => {
    ...
    legend.onAdd = () => {
      ...
      div.innerHTML = `
        <div class="flex flex-col border-b border-slate-200 pb-2 mb-2">
            <div class="font-extrabold text-slate-800 uppercase tracking-widest mb-1">Analysis Index</div>
            <div class="text-[10px] text-slate-500 font-medium flex items-center gap-1">
               <span>💡</span> This analysis uses synthetic trend data — see Data Sources for details
            </div>
        </div>
